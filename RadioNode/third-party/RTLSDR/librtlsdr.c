...
#include <RTLSDR/include/tuner_e4k.h>
#include <RTLSDR/include/tuner_fc0012.h>
#include <RTLSDR/include/tuner_fc0013.h>
#include <RTLSDR/include/tuner_fc2580.h>
#include <RTLSDR/include/tuner_r82xx.h>
	...
	for(i = 0; i < dev->xfer_buf_num; ++i) {
		...
		if (r < 0) {
			fprintf(stderr, "Failed to submit transfer %i\n"
					...
					"usbfs buffer number_of_points with the "
					"following command:\n"
